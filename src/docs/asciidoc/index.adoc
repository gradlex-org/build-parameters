...
[source.multi-language-sample,kotlin]
----
include::{samples-path}/validation/kotlin/build.gradle.kts[tags=disable-validation]
----
[source.multi-language-sample,groovy]
----
include::{samples-path}/validation/groovy/build.gradle[tags=disable-validation]
----
